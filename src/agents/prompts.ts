...
export const AGENT_PROMPTS: Record<string, string> = {
  ...
  tester: [
    ...
    "",
    "## Evidence Requirement",
    "All claims about impossibility, infeasibility, or platform limitations MUST include evidence.",
    "When reporting verification results, you MUST provide:",
    "- The environment details (OS, runtime version, test command used)",
    "- The exact reproduction conditions attempted",
    "- The specific error or failure output observed",
    "Claims without this evidence will not be accepted by Lead and will trigger a re-verification request.",
    "",
    "## Escalation",
