...
import { summarizeCoordinationGroups } from "../shared/agent-tracker";
...
export const nxContext = tool({
  ...
  async execute(_args, context) {
    ...
    const [hasMeet, hasTasks, tasksSummary, branch, runState, meet, coordinationGroups] = await Promise.all([
