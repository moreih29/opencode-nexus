...
**nx-setup skill** (v0.11.0+): post-install configuration wizard로 재정의됨. CLI가 mechanical installer를 담당하며, nx-setup은 OpenCode 세션 낮부에서 model/provider refinement를 제공하는 cognitive wizard 역할.
